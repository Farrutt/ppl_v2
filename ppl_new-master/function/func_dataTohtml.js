...
function genHtmlCs(data,  document_id, ref_qt) {
  try {
    ...
    html +=       `<tr class='font_table'>
                      ...
                      <td class='td_center table_td_th table_height_td'>${numberToComma(docData['Total_Revenue'])}</td>
                    ...
                    <tr class='font_table'>
                      ...
                      <td class='bgcolor_table2 td_center table_td_th table_height_td'><b>${numberToComma(docData['Total_Revenue'])}</b></td> 
